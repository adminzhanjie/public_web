...
// 登录接口 
export const login = (params) => { return loginreq("post", "/api/adminuser/adminuser_login", params) };
// 获取用户菜单
 ...
 **/
// 用户管理-获取用户列表
export const userList = (params) => { return req("post", "/api/User/list") };
// 用户管理-保存（添加编辑）
 ...
 **/
// 学校管理-获取学校列表
export const deptList = (params) => { return req("post", "/api/school/list_school", params) };
// 学校管理-保存（添加编辑）
export const deptSave = (params) => { return req("post", "/api/school/save_school", params) };
// 学校管理-删除学校
